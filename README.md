...
R package to apply RELIEF harmonization to multi-site or multi-scanner neuroimaging studies. This method has been previously called as **UNIFAC harmonization**.

### References

> Zhang, R., Oliver, L. D., Voineskos, A. N., Park, J. Y. (2022). RELIEF: a structured multivariate approach for removal of latent inter-scanner effects. bioRxiv, 2022-08. [article link](https://doi.org/10.1101/2022.08.01.502396)
